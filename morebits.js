...
/*
 ...
 WikiLovesMonumentsCoordinates script
 - includes morebits.js from http://en.wikipedia.org/wiki/MediaWiki:Gadget-morebits.js
 - uses Google Maps API

 !!! Important !!!
 - does not detect whether the page contains a list of monuments. On other pages the script will have unexpected behavior

 Version 0.3
 - form description is updated

 Version 0.2
 - button is changed to a link
 - setting a marker with low zoom is not allowed
 - saving with empty inputs is not allowed
